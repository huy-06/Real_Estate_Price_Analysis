...
\section{Giới thiệu}
Thị trường bất động sản đóng vai trò thiết yếu đối với nền kinh tế nhưng thường chịu ảnh hưởng bởi nhiều yếu tố phức tạp như vị trí, diện tích, tiện ích, khiến việc xác định mức giá hợp lý trở thành thách thức lớn. Dự án tập trung ứng dụng phân tích dữ liệu từ tin đăng bất động sản để định lượng các yếu tố tác động đến giá bất động sản, cung cấp cơ sở khách quan giúp người mua đưa ra quyết định phù hợp nhất. Kết quả nghiên cứu được kỳ vọng sẽ nâng cao tính minh bạch của thị trường và tạo tiền đề cho các ứng dụng phân tích chuyên sâu.
...
\multirow{2}{2.5cm}{\textbf{1. Mục tiêu \& Tham chiếu}} 
 & 1 & \texttt{price\_total} & Float & Biến mục tiêu: Tổng số tiền người bán mong muốn (VND) \\ \cline{2-5}
...
\multirow{2}{2.5cm}{\textbf{2. Scrub}} 
 & 3 & Kiểm tra, xử lý dữ liệu nhiễu và khuyết thiếu. & ... \\ \cline{2-4}
